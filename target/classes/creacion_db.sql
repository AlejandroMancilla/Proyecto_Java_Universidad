DROP DATABASE IF EXISTS UNI_SABIOS;
CREATE DATABASE IF NOT EXISTS UNI_SABIOS;
USE UNI_SABIOS;
...
CREATE TABLE programs (
	...
	program_level ENUM('Pre-Graduate', 'Post-Graduate') NOT NULL,
