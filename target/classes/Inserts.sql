...
INSERT INTO persons (document_type, document_numb, name, last_name, phone_number, date_birth, gener, city_id, address_id) VALUES
-- Personas jóvenes
('C.C.', '123456789', 'Juan', 'Gomez', '3001234567', '2000-01-01', 1, 1, 1),
('T.I.', '987654321', 'Maria', 'Rodriguez', '3012345678', '2001-02-02', 2, 2, 2), 
('C.E.', '567890123', 'Carlos', 'Martinez', '3023456789', '2002-03-03', 1, 3, 3), 
...
('C.E.', '456789012', 'Valentina', 'Sanchez', '3078901234', '2000-11-08', 2, 2, 8),
('C.C.', '789012345', 'Pedro', 'Ramirez', '3089012345', '2005-29-09', 1, 2, 9), 
('T.I.', '012345678', 'Laura', 'Diaz', '3209876543', '2004-17-10', 2, 3, 10), 
...
('C.E.', '567490123', 'Andres', 'Martinez', '3023456789', '1970-03-03', 1, 2, 15),
...
('C.E.', '456089012', 'Laura', 'Sanchez', '3078901234', '1945-08-08', 2, 3, 20);
...
INSERT INTO programs (program_name, program_level) VALUES
('Ingeniería Informática', 'Pre-Graduate'),
('Administración de Empresas', 'Pre-Graduate'),
('Psicología', 'Pre-Graduate'),
('Arquitectura', 'Pre-Graduate'),
('Medicina', 'Pre-Graduate'),
('Derecho', 'Pre-Graduate'),
('Ciencias de la Computación', 'Pre-Graduate'),
('Economía', 'Pre-Graduate'),
('Ingeniería Civil', 'Pre-Graduate');
...
INSERT INTO registers (student_id, period_id, signature_id) VALUES
(1, 1, 1),
(1, 1, 2),
(1, 1, 3),
(2, 1, 1),
